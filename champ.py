...
class Champ(Base):
    ...
    def attack_action(self, enemy=None):
        ...
        if self.champ_class in ["Fighter", "Rogue"]:
    ...
    def defend_action(self, dmg):
        value = ((self.defence/100)*dmg) + ((self.dmg_reduction/100)*dmg)
        return value
    ...
    def total_defence(self, dmg, enemy=None):
        ...
        if 1 <= rand <= self.speed:
            ...
            self.T_dmg_taken = value - self.defend_action(dmg)
